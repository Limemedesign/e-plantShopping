...
function ProductList() {
    ...
    // Use selector to get cart items and calculate the total quantity
        ...
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                    ...
                    {totalQuantity > 0 && <span className="cart-quantity">{totalQuantity}</span>} {/* Display total quantity */}
                    </a>
                </div>
            </div>
        </div>
